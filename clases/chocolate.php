...
class Chocolate {
	...
	protected $iidchocolate; // ID del chocolate, es un integer.
	protected $cnombre;// nombre del chocolate, es un string.
	protected $cdescripcion;//descripción del chocolate, es string.
